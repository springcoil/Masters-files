...
\usepackage{amsthm, amsmath, amssymb, amsfonts, color, hyperref, url, textcomp}
...
\def \hodge{*}
\def \iso {\cong}
\title{\bf The Laplace Operator on Manifolds and Cauchy Problem}
...
\include{Laplace}
\include{PDE_Examples}
\newpage
\include{LieDerivatives}
\newpage
\include{heatkernel}
\newpage
\include{yangmills}
\newpage
\include{MetricConnections}
\newpage
\include{BerryPhase}
\newpage
\include{FeynmanKac}
